...
//@EnableConfigurationProperties(HttpClient.class)
public class HttpClientAutoConfigeration {

    private final HttpClientEntity httpClientEntity;
...
//    @ConditionalOnMissingBean(HttpClient.class)
    public HttpClient httpClient(){
        ...
        HttpClient client = HttpClientBuilder.create().setDefaultRequestConfig(requestConfig).setUserAgent(httpClientEntity.getAgent())
                .setMaxConnPerRoute(httpClientEntity.getMaxConnPerRoute()).setConnectionReuseStrategy(new NoConnectionReuseStrategy()).build();
        return client;
    }
}
